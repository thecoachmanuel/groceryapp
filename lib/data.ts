const dummyData = {
  categories: [
    { name: 'Fruits & Vegetables', description: 'Farm fresh organic fruits & vegetables' },
    { name: 'Dairy & Eggs', description: 'Fresh milk, butter, cheese & farm eggs' },
    { name: 'Bakery & Bread', description: 'Artisanal bread, pastries & baked goods' },
    { name: 'Beverages & Drinks', description: 'Fresh juices, sparkling drinks & milk' },
    { name: 'Meat & Seafood', description: 'Fresh poultry, prime beef cuts & seafood' },
    { name: 'Snacks & Confectionery', description: 'Crunchy nuts, chips, chocolates & sweets' },
    { name: 'Pantry & Grains', description: 'Extra virgin oils, grains & pantry staples' },
  ],
